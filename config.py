...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8133651157:AAGLtJE-qu218XeFWPhItYtvKjqIOWjQ5Gg")
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://nakflix254:alpha3720@nakflixlink8bot.5r7ljcz.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "nakflixlink8bot")
...
FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1001878979530"))
FORCE_SUB_CHANNEL_4 = int(os.environ.get("FORCE_SUB_CHANNEL_4", "-1001855603689"))
